...
public class PieChartItem extends ChartItem {
    ...
    public View getView(int position, View convertView, Context c) {
        ...
        if (convertView == null) {
            ...
            holder.chart = (PieChart) convertView.findViewById(R.id.pieChart);
    ...
    private SpannableString generateCenterText() {
        SpannableString s = new SpannableString("created by\nJosie");
        s.setSpan(new RelativeSizeSpan(.9f), 0, 11, 0);
        s.setSpan(new ForegroundColorSpan(Color.GRAY), 0, 11, 0);
        s.setSpan(new RelativeSizeSpan(1.4f), 11, s.length(), 0);
